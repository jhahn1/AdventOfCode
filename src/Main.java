...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HeardYouLikeRegisters heardYouLikeRegisters = new HeardYouLikeRegisters();

        System.out.println(heardYouLikeRegisters.getLargestValue(getInput()));
    }

    public static String getInput() {
        return "d dec 461 if oiy <= 1\n" +
