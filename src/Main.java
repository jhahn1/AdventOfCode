...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HighEntrophyPassphrases highEntrophyPassphrases = new HighEntrophyPassphrases();

        System.out.println(highEntrophyPassphrases.getNumOfValidPassphrasesPart2(getInput()));
    }
